class Quote < Statement
  ...
  #validates_uniqueness_of :email_address, :message => "email address already registered"
  ...
  def self.allowed_quotes(user)
    Quote.where(student: Student.allowed_students(user))
  end
end
